...
pub fn filter_sobel_render(
    ...
    update_uniform(renderer, &queue, filter_sobel, (resource.use_w(), resource.use_h()));
    effect_render(
        device,
        queue,
        encoder,
