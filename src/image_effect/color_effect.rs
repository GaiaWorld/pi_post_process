...
use crate::{material::{tools::load_shader}, temprory_render_target::PostprocessTexture, effect::{blur_direct::BlurDirect, color_effect::ColorEffect}};
...
impl TImageEffect for EffectColorEffect {
    ...
    const KEY: &'static str = "EffectColorEffect";

    fn shader(device: &RenderDevice) -> crate::material::tools::Shader {
        load_shader(
            device,
            include_str!("../shaders/color_effect.vert"),
