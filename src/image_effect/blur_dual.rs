...
use crate::{material::{tools::load_shader}, temprory_render_target::PostprocessTexture, effect::{blur_direct::BlurDirect, blur_dual::{BlurDual, BlurDualForBuffer}}};

use super::base::{TImageEffect, ImageEffectResource, KeyPostprocessPipeline};


pub struct EffectBlurDual {
...
impl TImageEffect for EffectBlurDual {
    ...
    const KEY: &'static str = "EffectBlurDual";
