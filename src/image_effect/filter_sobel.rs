...
use crate::{material::{tools::load_shader}, temprory_render_target::PostprocessTexture, effect::{blur_direct::BlurDirect, filter_sobel::FilterSobel}};

use super::base::{TImageEffect, ImageEffectResource, KeyPostprocessPipeline};


pub struct EffectFilterSobel {
...
impl TImageEffect for EffectFilterSobel {
    ...
    const KEY: &'static str = "EffectFilterSobel";

    fn shader(device: &RenderDevice) -> crate::material::tools::Shader {
        load_shader(
            device,
            include_str!("../shaders/sobel.vert"),
