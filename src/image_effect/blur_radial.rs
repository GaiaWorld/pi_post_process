...
use crate::{material::{tools::load_shader}, temprory_render_target::PostprocessTexture, effect::{blur_direct::BlurDirect, blur_radial::BlurRadial}};

use super::base::{TImageEffect, ImageEffectResource, KeyPostprocessPipeline};


pub struct EffectBlurRadial {
...
impl TImageEffect for EffectBlurRadial {
    ...
    const KEY: &'static str = "EffectBlurRadial";

    fn shader(device: &RenderDevice) -> crate::material::tools::Shader {
        load_shader(
            device,
            include_str!("../shaders/blur_radial.vert"),
