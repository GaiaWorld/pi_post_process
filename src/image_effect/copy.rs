...
use crate::{material::{tools::load_shader}, temprory_render_target::PostprocessTexture, effect::{blur_direct::BlurDirect, color_effect::ColorEffect, copy::CopyIntensity}};

use super::base::{TImageEffect, ImageEffectResource, KeyPostprocessPipeline};


pub struct EffectCopy {
...
impl TImageEffect for EffectCopy {
    ...
    const KEY: &'static str = "EffectCopy";
